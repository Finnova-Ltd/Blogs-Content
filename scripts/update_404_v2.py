...
<head>
  ...
  <style>
    ...
    .hero-404 {
      ...
      text-align: center;
      background: radial-gradient(circle at 50% 15%, #e0f2fe 0%, #f8fafc 70%);
    }
    .hero-container {
      max-width: 920px;
      margin: 0 auto;
    ...
    /* Blog & Guides Preview Section (Image 2 Match) */
    .guides-section {
      max-width: 1200px;
      margin: 0 auto 64px;
      padding: 0 24px;
  ...
  <main>
    <section class="hero-404">
      <div class="hero-container">
        <span class="badge-404">Error 404 • Page Not Found</span>
    ...
    <!-- Mortgage Guides & Insights Preview Section (Image 2 Match) -->
...
print("✅ Saved updated 404.html with official website logo, R BAKSHI consistency, and Image 2 guides grid")
